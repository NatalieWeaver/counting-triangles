...
\begin{tikzpicture}
	...
	\triangleoutline         
	\node[align = left] at (7, 9) {How many triangles are there?};
    	\node[align = right] at (7, 8) {$\triangle = \triangle A + \triangle B - \triangle AB$ \\ = \arabic{countA} + \arabic{countB} - \arabic{countAB} = \the\numexpr\arabic{countA}+\arabic{countB}-\arabic{countAB}};
